...
typedef struct
{
	volatile u32	dwDTERate;
	volatile u8	bCharFormat;
	volatile u8 	bParityType;
	volatile u8 	bDataBits;
	volatile u8	lineState;
	volatile u8  isOpened;
} LineInfo;

/* Define the vendor id and product id */
#define USBD_VID        0x2341
#ifdef __BlunoM0__
#define USBD_PID        0x0143
#else
#define USBD_PID        0x0244
#endif
